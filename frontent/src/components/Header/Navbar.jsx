  ...
  return (
    <header className="shadow sticky z-50 top-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
      <nav className="px-2 lg:px-6 py-2.5">
        {/* Changed flex-wrap to flex-nowrap on smaller screens to prevent line breaks */}
        <div className="flex flex-nowrap justify-between items-center mx-auto max-w-screen-xl">
          
          {/* Logo - Reduced gap and simplified structure */}
          ...
          {/* Actions (Right Side) - Added flex-nowrap and flex-shrink-0 */}
          <div className="flex items-center lg:order-2 flex-nowrap flex-shrink-0">
            ...
            <Link
              to="/login"
              className="text-slate-800 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-slate-800 font-medium rounded-lg text-xs lg:text-sm px-2 lg:px-5 py-2 focus:outline-none whitespace-nowrap"
            >
              Log in
            </Link>
            <Link
              to="/register"
              className="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-xs lg:text-sm px-3 lg:px-5 py-2 focus:outline-none shadow-lg shadow-blue-500/20 whitespace-nowrap"
            >
              Get started
            </Link>
